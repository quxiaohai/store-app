 ...
 */
var _e = Object.defineProperty, M = Object.getOwnPropertySymbols, ve = Object.prototype.hasOwnProperty,
    be = Object.prototype.propertyIsEnumerable,
    B = (t, e, i) => e in t ? _e(t, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : t[e] = i,
    k = (t, e) => {
        for (var i in e || (e = {}))
...
const A = (t, e = 'style') => t ? (t.getAttribute(e) || '').split(/\s?;\s?/).reduce((s, n) => {
    ...
    }, Te = 'sp-editor__editor', D = 'is-empty', ie = 'SECTION', He = 'BR',
    se = [ie, 'H1', 'H2', 'H3', 'H4', 'H5', 'BLOCKQUOTE', 'UL', 'OL'];
...
const Re = ['#333333', '#d0d0d0', '#ED4448', '#ff752d', '#19ea6a', '#FFC32E', '#683DF5'], Me = {
    tag: 'dl',
    attrs: {
...
class Fe {
    ...
    _initChildEl(e) {
        const { textColor: i, childNodeName: s } = e, {
                textStyleTitle: n,
                textStyleHeadLeftBtnText: r,
                textStyleColors: o
            } = this.options, a = f('div', { class: `${C}__header` }, n), l = f('div', { class: '__left' }, r),
            E = f('div', { class: '__switch' });
        a.append(l, E);
        const u = [Me], c = o;
        if (c.length) {
...
const Ue = {
    ...
    toolbarButtons: ['choose-picture', 'text-style', 'face']
};
 ...
 */
var ze = Object.defineProperty, W = Object.getOwnPropertySymbols, Ge = Object.prototype.hasOwnProperty,
    Ve = Object.prototype.propertyIsEnumerable,
    z = (t, e, i) => e in t ? ze(t, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : t[e] = i,
    G = (t, e) => {
        for (var i in e || (e = {}))
        ...
        return (() => {
            var i = {
                949: (n, r) => {
                    ...
                    var a = o(949);
                    Object.defineProperty(r, 'toTwoDigits', {
...
function V(t, e, i, s) {
    ...
    o.onload = () => {
        ...
        e.cropInfo && e.cropInfo.sw && e.cropInfo.sh ? q(a, e, i, s, {
            ...
            dw: e.cropInfo.sw,
            dh: e.cropInfo.sh
        }) : e.width && e.height ? q(a, e, i, s, st(a, e)) : e.width || e.height || e.longEdge ? it(a, e, i, s) : P({
            ...a,
            raw: a
        }, e, i);
    }, o.onerror = s, o.src = t;
...
function pe(t, e, i, s, n) {
    const r = R(t, s), o = /^\w+\/\*$/.test(i.mimeType) || !i.mimeType ? e.type : i.mimeType,
        a = r.toDataURL(o, i.quality), l = ue(a, o);
    n({
        element: r,
        type: o,
        width: r.width,
